...
export const eulerMaruyamaSnippets: MatlabSnippet[] = [
  {
    id: 'euler-maruyama-full',
    label: 'Euler-Maruyama implementation',
    code: `function [t, X, dB, B] = euler_maruyama(a, b, x0, T, N, seed)
